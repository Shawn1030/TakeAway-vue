 ...
 <div class="msite_shop_list border-1px">
        ...
        <div class="shop_container">
          <ul class="shop_list" v-if="shops.length>0">
            ...
            :key="shop.id" @click="$router.push('/shop')">
              <a>
                <div class="shop_left">
                ...
                <div class="shop_right">
                  <section class="shop_detail_header">
                    <h4 class="shop_title ellipsis" >{{shop.description}}</h4>
                  ...
                  <section class="shop_rating_order">
                    <section class="shop_rating_order_left">
                      ...
                      <div class="order_section">
                        月售 {{shop.rating_count}}
                      </div>
                    </section>
                    <section class="shop_rating_order_right">
                      <span class="delivery_style delivery_left">{{shop.delivery_mode.text}}</span>
                      <span class="delivery_style delivery_right">{{shop.name}}</span>
                    </section>
                  </section>
