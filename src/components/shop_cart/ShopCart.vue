    ...
    <div class="shopcart">
      <div class="content">
        <div class="content-left" @click="showCart">
          ...
          <div class="price " :class="{highlight:totalCount}" v-if="totalCount">￥{{totalPrice}}</div>
      ...
      <transition name="fade"> 
          <div class="shopcart-list" v-show="showList">
           <div class="list-header">
            ...
            <span class="empty" @click="clearCarts">清空</span>
          </div>
      ...
      <transition name="fade">
        <div class="list-mask" v-show="showList" @click="showCart"></div>
      </transition>
  </div>
</template>
...
<script>
  ...
  import {CLEAR_SHOP_CART} from '../../store/mutation_types'
  export default {
